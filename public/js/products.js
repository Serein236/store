...
function renderProducts() {
    ...
    products.forEach(product => {
        ...
        row.innerHTML = `
            ...
            <td> $ {product.stock}</td>
            <td>
                <button class="btn btn-sm btn-primary btn-action" onclick="editProduct( $ {product.id})">编辑</button>
                <button class="btn btn-sm btn-danger btn-action" onclick="deleteProduct( $ {product.id})">删除</button>
            </td>
        `;
